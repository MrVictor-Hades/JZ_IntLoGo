...
class RtmMessage extends StatefulWidget {
  RtmMessage({Key key}) : super(key: key);

  @override
  _RtmMessageState createState() => _RtmMessageState();
}

class _RtmMessageState extends State<RtmMessage> {
  bool _isLogin = false;
  ...
  void _createClient() async {
    _client =
    await ARRtmClient.createInstance(config.AppId);
